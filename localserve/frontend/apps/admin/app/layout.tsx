...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en" suppressHydrationWarning><body><AppProviders><RoleShell role="Admin" person="Ananya Iyer" initials="AI" navigation={navigation}>{children}</RoleShell></AppProviders></body></html>; }
