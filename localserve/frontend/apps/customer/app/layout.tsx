...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" suppressHydrationWarning><body><AppProviders><RoleShell role="Customer" person="Aarav Sharma" initials="AS" navigation={navigation}>{children}</RoleShell></AppProviders></body></html>;
}
